    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="grid w-full max-w-4xl overflow-hidden rounded-[1.75rem] border border-border/70 bg-card shadow-[0_24px_60px_-28px_hsl(152_40%_20%/0.35)] md:grid-cols-[1.05fr_0.95fr]">
        <div className="food-hero hidden flex-col justify-between p-8 text-white md:flex">
          <div>
            <p className="food-chip bg-white/15 text-white">Surplus recovery platform</p>
            <h1 className="font-display mt-6 text-4xl font-semibold leading-tight">
              Redirect surplus food to community need.
            </h1>
            <p className="mt-4 text-sm leading-6 text-white/85">
              Register excess inventory, allocate donation and discount volumes, and coordinate
              pickup with nearby partners before cutoff.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <span className="food-chip">Donation</span>
          ...
          <CardHeader className="gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-muted-foreground">Business account access</p>
              </div>
            </div>
            <CardTitle>Sign in to your workspace</CardTitle>
            <p className="text-sm text-muted-foreground">
              Manage surplus inventory, match recipients, and track recovery outcomes.
            </p>
          </CardHeader>
          <CardContent>
